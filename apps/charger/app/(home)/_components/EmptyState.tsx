...
export const EmptyState = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-32 text-center">
      ...
      <p className="text-gray-500 text-sm mt-2 font-medium">충전 대기를 등록하시겠습니까?</p>
      <button
        onClick={() => setShowOnlyAvailable(false)}
        className="mt-8 px-6 py-2.5 rounded-full border border-gray-700 text-gray-300 tracking-widest uppercase hover:bg-gray-800 transition-colors"
      >
        전체 보기
      </button>
    </div>
